...
if __name__ == '__main__':
    # todo BEGIN - Select the task for benching ---------------------------
    # task = ['adding', 'color_changing', 'replacing'][1]
    # todo ENDS -----------------------------------------------------------
    ...
    for task in ['adding', 'color_changing', 'replacing']:
        ...
        edit_dir = os.path.join('task_scoring/flux_kontext_output_1024', task)
        ...
        results_df.to_csv(f'evaluation_results_{task}.csv', index=False)
        print("\n>> Evaluation complete.")
